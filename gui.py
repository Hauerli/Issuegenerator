...
b_addLabel = tk.Button(f_entrybutton,text='Add Label', command=add_label_entry)
b_generateIssues = tk.Button(t_main,text='Generate Issues')
b_print = tk.Button(f_entrybutton,text="Print", command=print_Label)
